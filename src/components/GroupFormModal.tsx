...
interface GroupFormModalProps {
  ...
  onClose: () => void;
  onSubmit: (groupData: { title: string; description: string }) => void;
}

export default function GroupFormModal({ isOpen, groupToEdit, onClose, onSubmit }: GroupFormModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-[#8C8C85] uppercase tracking-widest block">
              Group Title <span className="text-rose-700">*</span>
            </label>
            <input
              type="text"
              value={title}
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              placeholder="State the core objective or fund strategy for this group (e.g. Family savings, index tracking portfolios)"
              rows={3}
