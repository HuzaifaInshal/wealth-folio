...
export default function LedgerTable({
  ...
  return (
    <div className="fintech-card p-5 space-y-4 text-left rounded-lg">
      {/* Header Bar */}
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3.5 py-2 bg-slate-50 dark:bg-[#12131A] border border-slate-200 dark:border-slate-800/80 rounded-lg text-xs text-slate-900 dark:text-white font-medium focus:outline-hidden focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-purple-500 transition-all"
          />
        </div>

        {/* Type Filter dropdown */}
        <div className="flex items-center space-x-2 border border-slate-200 dark:border-slate-800/80 px-3 py-2 bg-slate-50 dark:bg-[#12131A] rounded-lg">
      ...
      {/* Table listing */}
      {filtered.length === 0 ? (
        <div className="py-12 border border-dashed border-slate-200 dark:border-slate-800/80 rounded-lg text-center space-y-2 p-6">
        ...
        <div className="overflow-x-auto border border-slate-100 dark:border-slate-800/80 rounded-lg">
